...
<!--DEJAR MENSAJE AQUI-->
<form action="DetallesDelCurso.php">
<div style="background-color: rgb(197, 197, 197); margin-right: 5%; padding:2%;">
<fieldset>
    <label for="mensaje">Deja tu mensaje hacia el tutor:</label><br>

    <textarea name="mensaje" id="mensaje" placeholder="Escribe tu mensaje aqui" cols="50" rows="10" required></textarea>
</fieldset>
